  ...
  const AKISTORE_APP = {
    ...
    searchSelectWidth() {
      const item = document.querySelectorAll(
        ".site-search .form-select.custom-width"
      );
      ...
      if (container !== null) {
        container.forEach((el) => {
          ...
          if (menu !== null) {
            ...
            // SUbmenu title
            const hasChildMenu = menu.querySelectorAll(
        ...
        if (categoryButton !== null) {
          for (var i = 0; i < categoryButton.length; i++) {
            ...
            self.addEventListener("click", (e) => {
              e.preventDefault();
              tl.play();
              $(".site-offcanvas nav.categories ul.departments-menu").addClass(
                "show"
              );
            });
          }
    ...
    mobileSearch: function () {
      ...
      var searchHolder = $(".kegd-mobile-search");
