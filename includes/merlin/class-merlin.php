...
class Merlin {
	...
	protected function license() {
        if(machic_get_registered_purchase_code()) {
	...
	protected function plugins() {
        if(empty(machic_get_registered_purchase_code())) {
            echo "<p>".esc_html__('Please verify the purchase code first.','machic')."</p>";
	...
	public function _ajax_activate_license() {
		...
		update_option( 'envato_purchase_code_34267600', $license_key );
