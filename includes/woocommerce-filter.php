...
/*************************************************
## Akistore Shop View Grid-List
 *************************************************/
function akistore_shop_view()
{
...
## Get Body Class
 *************************************************/
function akistore_get_body_class($class)
{
...
if (!function_exists('akistore_is_pjax')) {
	function akistore_is_pjax()
	{
		if (is_shop() || is_product_category()) {
